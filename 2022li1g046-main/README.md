...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g046.git
$ cd 2022li1g046
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g046.git
$ cd 2022li1g046
```
...
- **A100815** Miguel Tomás Antunes Pinto;
- **A104005** Tomás Araújo Santos;
